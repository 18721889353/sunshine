...
import (
	...
	"github.com/18721889353/sunshine/cmd/protoc-gen-go-gin/internal/generate/handler"
	"github.com/18721889353/sunshine/cmd/protoc-gen-go-gin/internal/generate/router"
	"github.com/18721889353/sunshine/cmd/protoc-gen-go-gin/internal/generate/service"
)
...
func saveGinRouterFiles(f *protogen.File) error {
	...
	if !bytes.Contains(ginRouterFileContent, []byte("middleware.")) {
		ginRouterFileContent = bytes.Replace(ginRouterFileContent, []byte(`"github.com/18721889353/sunshine/pkg/gin/middleware"`), []byte(""), 1)
	}
