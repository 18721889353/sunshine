...
func GenerateDBInitCommand() *cobra.Command {
	var (
		...
		dbDriver   string // database driver e.g. mysql, postgresql, sqlite
  ...
  sunshine patch gen-db-init --module-name=yourModuleName --db-driver=mysql

  # Generate database initialization code, auto detect the database driver name.
  sunshine patch gen-db-init --module-name=yourModuleName
...
`)
	...
	cmd.Flags().StringVarP(&dbDriver, "db-driver", "k", "", "database driver, support mysql, postgresql, sqlite")
	cmd.Flags().StringVarP(&moduleName, "module-name", "m", "", "module-name is the name of the module in the 'go.mod' file")
	cmd.Flags().StringVarP(&outPath, "out", "o", "", "output directory, default is ./mysql-init_<time>, "+
		"if you specify the directory where the web or microservice generated by sunshine, the module-name flag can be ignored")
