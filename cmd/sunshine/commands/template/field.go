...
func FieldCommand() *cobra.Command {
  ...
  sunshine template field --tpl-dir=yourTemplateDir --fields=yourDefineFields.json

  # Print template code and all fields, do not generate code.
  sunshine template field --tpl-dir=yourTemplateDir --fields=yourDefineFields.json --only-print
