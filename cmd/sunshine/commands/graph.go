...
func GenGraphCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "graph",
		Short: "Draw a business architecture diagram based on the project created by sunshine",
		Long:  "Draw a business architecture diagram based on the project created by sunshine.",
  ...
  sunshine graph --project-dir=/path/to/project

  # You can also specify multiple services to generate a business framework diagram
  sunshine graph --server-dir=/path/to/server1 --server-dir=/path/to/server2
