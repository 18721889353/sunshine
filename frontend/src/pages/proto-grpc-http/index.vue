<template>
  <div class="generate-page">
    <el-card class="main-card">
      <template #header>
        <span class="card-title">⑥基于<el-text type="danger">protobuf</el-text>创建grpc+http服务 <el-text type="info" size="small">生成通用的微服务项目代码</el-text></span>
      </template>
    ...
    <el-dialog v-model="showProtoExample" title="user.proto" width="900px">
      <pre style="margin:0;white-space:pre-wrap;word-break:break-all;font-size:13px;background:#f5f7fa;padding:16px;border-radius:4px;">syntax = "proto3";
