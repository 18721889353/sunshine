<template>
  <div class="generate-page">
    <el-card class="main-card">
      <template #header>
        <span class="card-title">生成service+handler CRUD代码</span>
      </template>
...
const {
  ...
  canSubmit: (f, { dbDriver, dsn, tables }) =>
    dbDriver && dsn && tables.length > 0 && f.serverName?.trim() !== '' && f.moduleName?.trim() !== '',
})
</script>
