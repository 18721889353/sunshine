...
import (
	...
	"github.com/18721889353/sunshine/pkg/shield/cpu"
	"github.com/18721889353/sunshine/pkg/shield/window"
)
...
func cpuproc() {
	...
	for range ticker.C {
		stat := &cpu.Stat{}
		cpu.ReadStat(stat)
		stat.Usage = minVal(stat.Usage, 1000)
