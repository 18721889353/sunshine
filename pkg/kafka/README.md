...
func main() {
	...
	msg := testData[0].(*sarama.ProducerMessage) // testData is https://github.com/18721889353/sunshine/blob/main/pkg/kafka/producer_test.go#L18
...
func main() {
	...
	go cg.Consume(context.Background(), []string{testTopic}, handleMsgFn) // handleMsgFn is https://github.com/18721889353/sunshine/blob/main/pkg/kafka/consumer_test.go#L19

	// Case 2: consume custom handle message
	go cg.ConsumeCustom(context.Background(), []string{testTopic}, &myConsumerGroupHandler{ // myConsumerGroupHandler is https://github.com/18721889353/sunshine/blob/main/pkg/kafka/consumer_test.go#L26
...
func main() {
	...
	go c.ConsumePartition(context.Background(), testTopic, 0, sarama.OffsetNewest, handleMsgFn) // // handleMsgFn is https://github.com/18721889353/sunshine/blob/main/pkg/kafka/consumer_test.go#L19
