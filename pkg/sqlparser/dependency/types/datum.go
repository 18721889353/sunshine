...
import (
	...
	"github.com/18721889353/sunshine/pkg/sqlparser/dependency/types/json"
	"github.com/18721889353/sunshine/pkg/sqlparser/dependency/util/charset"
	"github.com/18721889353/sunshine/pkg/sqlparser/dependency/util/hack"
)
...
func (d *Datum) convertToMysqlDuration(_ *stmtctx.StatementContext, target *FieldType) (Datum, error) {
	tp := target.Tp
	fsp := DefaultFsp
	if target.Decimal != UnspecifiedLength {
		fsp = target.Decimal
