...
import (
	...
	"github.com/18721889353/sunshine/pkg/sqlparser/dependency/model"
	"github.com/18721889353/sunshine/pkg/sqlparser/dependency/mysql"
	"github.com/18721889353/sunshine/pkg/sqlparser/dependency/util/auth"
)
...
type KillStmt struct {
	...
	// Query is true, terminates the statement the connection is currently executing, but leaves the connection itself intact.
	...
	Query        bool
	ConnectionID uint64
	// Extension is used to indicate extended kill syntax support.
	// When set, it indicates special kill command syntax is being used.
	Extension bool
}
