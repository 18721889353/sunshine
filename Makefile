...
.PHONY: patch
# Patch some dependent code, e.g. make patch TYPE=types-pb , make patch TYPE=init-<your_db_driver>, your_db_driver is mysql, for example: make patch TYPE=init-mysql
patch:
